resource "kubernetes_ingress_v1" "ingress_default" {
  depends_on = [helm_release.loadbalancer_controller,
                ...
                kubernetes_service_v1.movie_ui_service,
                kubernetes_service_v1.gateway_service,
                kubernetes_service_v1.erp_service,
                kubernetes_service_v1.movie_service,
  ...
  metadata {
    ...
    annotations = {
      # Load Balancer Name
      "alb.ingress.kubernetes.io/group.name" = "movie-lb"
      ...
      "external-dns.alpha.kubernetes.io/hostname" = "movie.greeta.net, movieapi.greeta.net, keycloak.greeta.net"
